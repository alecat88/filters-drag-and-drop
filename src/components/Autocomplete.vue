  ...
  <div class="complete">
    ...
    <div class="input">
      ...
      <div class="input-Box ma-1">
        <input type="text" class="input-ids" v-model="value" @keyup.down="currentDropdownSelection++" @keyup.up="selectNext" @input="currentDropdownSelection = 0" @keyup.enter="enterValueFromAutocomplete"/>
      </div>
       </draggable>
    </div>
...
export default {
  ...
  methods: {
    ...
    checkMove: function(evt){
      return this.checkIfAlreadyExist(evt.relatedContext.list,evt.draggedContext.element.id);
    },
    selectNext() {
      console.log('select');
    ...
    enterValueFromAutocomplete() {
      ...
      this.addFromAutocomplete(this.autocomplete[this.currentDropdownSelection])
    }
  },
  computed: {
    autocomplete() {
